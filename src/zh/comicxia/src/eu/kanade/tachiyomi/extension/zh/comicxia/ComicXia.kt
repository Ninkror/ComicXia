...
class ComicXia : ParsedHttpSource() {
    ...
    override fun latestUpdatesRequest(page: Int): Request {
        return GET("$baseUrl/categories?sort=updated&page=$page", headers)
    }
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        ...
        return chapters.distinctBy { it.url }.reversed() // Tachiyomi expects newest first usually, or we can leave it
    }
